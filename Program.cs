...
class Program
{
    ...
    static void Main()
    {
        Product[] products =
        {
            ...
            new Product{Id=9, Name="Zonrox",         Category="Household",   Price=150, RemainingStock=30},
            new Product{Id=10, Name="Keratin Plus",  Category="Household",   Price=57,  RemainingStock=5}
        };
        ...
        OrderHistory[] history, ref int historyCount)
    {
        while (true)
        {
            ...
            switch (choice)
            {
                case 1: ViewCart(products, cart); break;
                case 2: UpdateCart(products, cart); break;
                case 3: RemoveItem(products, cart); break;
                case 4: ClearCart(products, cart); break;
                case 5: Checkout(products, cart, history, ref historyCount); break;
                case 6: return;
        ...
        OrderHistory[] history, ref int historyCount)
    {
        ...
        Console.WriteLine(new string('-', 58));
        Console.WriteLine("Grand Total:".PadRight(38) + "PHP " + grandTotal.ToString("F2"));
        ...
        if (grandTotal >= 5000)
        {
            ...
            Console.WriteLine("Discount (10%):".PadRight(38) + "-PHP " + discount.ToString("F2"));
        }
        ...
        Console.WriteLine("Final Total:".PadRight(38) + "PHP " + finalTotal.ToString("F2"));
        Console.WriteLine(new string('-', 58));
        ...
        Console.WriteLine("Payment:".PadRight(38) + "PHP " + payment.ToString("F2"));
        Console.WriteLine("Change:".PadRight(38) + "PHP " + change.ToString("F2"));
    ...
    static void LowStock(Product[] products)
    {
        ...
        for (int i = 0; i < products.Length; i++)
        {
            ...
            {
                Console.WriteLine(products[i].Name + " has only " +
                products[i].RemainingStock + " stock(s) left.");
    ...
    static void ShowHistory(OrderHistory[] history, int count)
    {
        ...
        else
        {
            for (int i = 0; i < count; i++)
            {
                ...
                " - PHP " + history[i].FinalTotal.ToString("F2"));
            }
        }
